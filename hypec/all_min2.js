/*...
	/clipone/plugins/bootstrap-colorpalette/js/bootstrap-colorpalette.js
*/
/**
    ...
    var runModuleTools = function () {
        ...
        $('.panel-heading').bind('click', function (e) {
            ...
            if ($(this).hasClass("collapses")) {
                if($(this).find('a').text().trim() == 'Dashboard Workflow'){
                    sk.setClientParam('dashboard_workflow', 'max');
                ...
                if($(this).find('a').text().trim() == 'Dashboard Workflow'){
                    sk.setClientParam('dashboard_workflow', 'min');  
                    setTimeout(function(){
                    $("#healthCardWorkflow").focus();
                    },200);
                }
